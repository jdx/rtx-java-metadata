...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru17-certified-binaries/releases/download/${tag_name}/${asset_name}"
...
download_github_releases 'ibmruntimes' 'semeru17-certified-binaries' "${RELEASE_FILE}"
